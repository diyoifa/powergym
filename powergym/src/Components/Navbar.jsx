  ...
  return (
    <div className="nav">
      <div className="container nav__container">
        ...
        <button
          className="nav__toggle-btn-avatar"
        ...
        <ul
          className={`nav__links-profile ${
            isProfileOptionShowing ? "show__nav-profile" : "hide__nav-profile"
          }`}
        >
          <li>
            <NavLink
              to={`/user/${user.currentUser?._id}`}
              onClick={() => {
                setIsProfileOptionShowing((prev) => !prev);
                window.scroll({ top: -1800, left: 100, behavior: "smooth" });
              }}
            >
              Mi perfil
